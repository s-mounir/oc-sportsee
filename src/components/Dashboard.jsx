...
function Dashboard(props) {
    ...
    const activity = props.dataactivity?.data
    const session = props.datasessions?.data
    ...
    return (
        <div>
                    ...
                    <DashboardDiv ref={ref}>
                        <BarChart data={activity} width={barChartWidth}/>
                        <LineChart data={session} width={columnWidth} />
                        <RadarChart data={performance} width={columnWidth} />
                        <RadialBarChart data={userInfo.todayScore} width={columnWidth}/>
                        <DashboardCards>
                            <InfoCard label='Calories' data={userInfo.keyData.calorieCount}>
                            ...
                            <InfoCard label='Proteines' data={userInfo.keyData.proteinCount}>
                                <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <InfoCard label='Glucides' data={userInfo.keyData.carbohydrateCount}>
                                <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <InfoCard label='Lipides' data={userInfo.keyData.lipidCount}>
                                <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
